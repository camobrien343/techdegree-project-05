...
<g><path d="M626.9,304L500,430.9L373.1,304L304,373.1L430.9,500L304,626.9l69.1,69.1L500,569.1L626.9,696l69.1-69.1L569.1,500L696,373.1L626.9,304z M500,10C229,10,10,229,10,500s219,490,490,490s490-219,490-490S771,10,500,10z M500,892c-216.1,0-392-175.9-392-392c0-216.1,175.9-392,392-392c216.1,0,392,175.9,392,392C892,716.1,716.1,892,500,892z"/></g>
	...
	// Stores states of app variables
	let state = {
	    employee: [],
	    filteredEmployee: [],
	    modalWindow: false,
	...
	// Object to store to JSON request 
	let getData = {
	...
	// Object to store html renders of cards and modals
	let render = {
		employeeCards: function() { // Creates the employee card 
		...
		employeeModal: function() { // Creates the modal window content
	...
	// Functions created to assist in other areas of program
	...
	// Init runs right away to get JSON request and store into state properties
	function init() {
	    ...
	    // Search input event listeners for directory search
